package com.lhm.springcloud.mybatisplusgenerator.utils;
...
public class CodeGenerator {
    ...
    private static String packageInfo = "com.lhm.springcloud";
    ...
    public static void main(String[] args) {
        ...
        System.out.println("文件生成到：" + modelName + "模块中 " + packageInfo + " 下，如需更换模块或生成位置请修改28、29行");
        ...
        pc.setModuleName(scanner("父级包名（包前缀为" + packageInfo + "）"));
...
//        templateConfig.setController(null).setMapper(null).setService(null).setServiceImpl(null);
